...
public class TaskSorter {
    ...
    private final CreateGraph<Task, Dependency> graph;
    ...
    public TaskSorter() {
        ...
        this.graph = new CreateGraph<Task, Dependency>();
    ...
    public Set<Task> getTasks() {
        ...
        Set<Task> allTasks = new HashSet<>(graph.getAllNodes());
        return allTasks;
    ...
    public Set<Dependency> getOutgoingDependencies(Task t) {
        ...
        Set<Dependency> outgoingEdges = new HashSet<>();
        for (CreateGraph.Edge<Task, Dependency> current : graph.getAllEdges()) {
            if (current.getParent().equals(t)) {
                outgoingEdges.add(current.getLabel());
            }
        }
