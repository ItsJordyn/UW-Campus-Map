...
public class GraphTestDriver {
    ...
    private final Map<String, CreateGraph<String, String>> graphs = new HashMap<String, CreateGraph<String, String>>();
    ...
    private void createGraph(String graphName) {
        ...
        graphs.put(graphName, new CreateGraph<String, String>());
    ...
    private void addNode(String graphName, String nodeName) {
        // TODO Insert your code here.
        CreateGraph<String, String> currentGraph = graphs.get(graphName);
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        Comparator<CreateGraph.Edge<String, String>> comparator = new Comparator<CreateGraph.Edge<String, String>>() {
            @Override
            public int compare(CreateGraph.Edge<String, String> o1, CreateGraph.Edge<String, String> o2) {
                return o1.getLabel().compareTo(o2.getLabel());
            }
        };

        List<CreateGraph.Edge<String, String>> edgesOut = currentGraph.edgesOut(parentName);
        Collections.sort(edgesOut, comparator);

        output.print("the children of " + parentName + " in " + graphName + " are:");
            for (CreateGraph.Edge<String, String> edge : edgesOut) {
