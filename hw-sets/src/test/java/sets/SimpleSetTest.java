...
public class SimpleSetTest {
  ...
  public void testToString() {
    ...
    assertEquals("R \\ {1.0}", S1.complement().toString());
    assertEquals("R \\ {1.0, 2.0}", S12.complement().toString());
    assertEquals("R \\ {1.0, 2.0, 3.0}", S123.complement().toString());
  }
