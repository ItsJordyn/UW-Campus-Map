...
/**
 * This represents an immutable path between two points (of a generic type), particularly
...
public class Path<T> implements Iterable<Path<T>.Segment> {
     ...
     */
    @Override
    public Iterator<Path<T>.Segment> iterator() {   // AHHH WHAT DO I DOO HERE?!
    ...
    public class Segment {
        ...
        public boolean equals(Object obj) {
            ...
            if(!(obj instanceof Path<?>.Segment)) { // do I change this to path.segment??!
                return false;
            }
